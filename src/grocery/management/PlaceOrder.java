...
public class PlaceOrder extends javax.swing.JFrame
{
    ...
    public void validateField()
    {
        ...
        String entmail=Login.enteredmail;
        if(customerEmail.equals(entmail) && customerMobileNumber.matches(mobileNumberPattern) && customerMobileNumber.length()==10 && customerEmail.matches(emailPattern) && grandTotal>0)
    ...
    private void initComponents()
    {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 30, 30, 30));

        jLabel2.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Bill ID");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(68, 111, -1, -1));

        jLabel3.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("..");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(171, 111, 42, -1));

        jLabel4.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Customer Details:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(68, 157, 154, -1));

        jLabel5.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Name");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, 139, 18));

        jLabel6.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Mobile No");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 270, 122, -1));

        jLabel7.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Email");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 370, 66, -1));

        txtCusName.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        ...
        getContentPane().add(txtCusName, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 220, 190, -1));

        txtCusMobileNo.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        ...
        getContentPane().add(txtCusMobileNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 310, 190, -1));

        txtCusEmail.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        ...
        getContentPane().add(txtCusEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 410, 190, -1));

        jLabel8.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Category");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 111, 106, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 154, 241, -1));

        jLabel9.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Search");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 190, 84, -1));

        txtSearch.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        ...
        getContentPane().add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 220, 241, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 307, 241, 330));

        jLabel10.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Name");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 110, 40, -1));

        txtProName.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        getContentPane().add(txtProName, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 150, 202, -1));

        jLabel11.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Price");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 110, 40, -1));

        txtProPrice.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        ...
        getContentPane().add(txtProPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 150, 211, -1));

        jLabel12.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Quantity");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 190, 181, -1));
        ...
        getContentPane().add(jSpinner1, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 220, 202, -1));

        jLabel13.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Total");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 190, 53, -1));

        txtProTotal.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        ...
        getContentPane().add(txtProTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 220, 210, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 260, 100, -1));

        btnAddToCart.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        ...
        getContentPane().add(btnAddToCart, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 260, -1, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 315, 491, 320));

        jLabel14.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Grand Total Rs:");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 650, -1, -1));

        lblGrandTotal.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        lblGrandTotal.setForeground(new java.awt.Color(255, 255, 255));
        lblGrandTotal.setText("00");
        getContentPane().add(lblGrandTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 650, 40, 20));

        btnBill.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        btnBill.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/generate bill & print.png"))); // NOI18N
        btnBill.setText("Bill and Print");
        ...
        getContentPane().add(btnBill, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 650, -1, -1));

        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/full-page-background.PNG"))); // NOI18N
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -1, 1360, 770));
    ...
    {//GEN-HEADEREND:event_txtCusMobileNoActionPerformed
        // TODO add your handling code here:
    ...
    {//GEN-HEADEREND:event_txtCusNameActionPerformed
        // TODO add your handling code here:
    ...
    {//GEN-HEADEREND:event_txtCusEmailActionPerformed
        // TODO add your handling code here:
    ...
    {//GEN-HEADEREND:event_txtProPriceActionPerformed
        // TODO add your handling code here:
    ...
    {//GEN-HEADEREND:event_txtProTotalActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtProTotalActionPerformed

    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_btnAddToCartActionPerformed
    {//GEN-HEADEREND:event_btnAddToCartActionPerformed
        // TODO add your handling code here: when add to cart is pressed it has to be added ot the below table
        ...
        clearProductFields();
        validateField(); //grand total will change val frm 0 to some val so it will validate
    ...
    {//GEN-HEADEREND:event_btnBillActionPerformed
       ...
       // String createdBy=userEmail;
        ...
        //creating document
        String path="C:\\Users\\SANATH\\Grocery Pdf";
        com.itextpdf.text.Document doc=new com.itextpdf.text.Document();
        try
        {
            PdfWriter.getInstance(doc,new FileOutputStream(path +"" +billId+".pdf"));
            doc.open();
            Paragraph shopName=new Paragraph("                                                 FRESHMART\n");
            doc.add(shopName);
    ...
    {//GEN-HEADEREND:event_formComponentShown
        billId=Integer.parseInt(BillDao.getId());  //to pdf
    ...
    {//GEN-HEADEREND:event_jTable1MouseClicked
        int index=jTable1.getSelectedRow(); //whenever the mouse is clicked on the name tabel then the corresponding value has to be diplayed on fields
    ...
    {//GEN-HEADEREND:event_txtCusNameKeyReleased
        // TODO add your handling code here:
        validateField();
    ...
    {//GEN-HEADEREND:event_txtCusMobileNoKeyReleased
        // TODO add your handling code here:
        validateField();
    ...
    {//GEN-HEADEREND:event_txtCusEmailKeyReleased
        // TODO add your handling code here:
        validateField();
